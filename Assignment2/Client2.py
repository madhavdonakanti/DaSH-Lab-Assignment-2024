...
def send_prompt(prompt):
    ...
    response = requests.post(SERVER_URL, json={"prompt": prompt,"ClientID":"swgdbd926%$@bshw"})
...
empty_data = []
with open('/home/madhav/Documents/DaSHLab/Assignment2/output2.json', 'w') as json_file:
...
while i<9 :
    ...
    with open("/home/madhav/Documents/DaSHLab/Assignment2/output2.json", "r") as json_file:
